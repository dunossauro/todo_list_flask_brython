...
def task_register(evt):
    ...
    if not name.value:
        ...
        error_message(
            'Ei, o campo "Nome" da sua tarefa está muito grande,\
             o limite é 80 caracteres'
        )
        return

    elif len(desc.value) > 300:
        error_message(
            'Ei, o campo "Descrição" da sua tarefa está muito grande,\
            o limite é 300 caracteres'
        )
        return
